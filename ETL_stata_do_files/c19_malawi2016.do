...
cd "~/Dropbox/LSMS_Compilation/Data/malawi_2016/"
...
use "IHS4 Consumption Aggregate.dta" , clear
...
keep 	case_id ea_id district TA region area urban sdate smonth syear hhsize hh_wgt pline_2016 ///
		poor *consumption che*
...
collapse 	(max) ill* chronic* d07a d07b d35a d35b ///
			(min) d04 d06a d06b d13 d17 d18 d33 d36a d36b d45  ///
			, by(case_id)
